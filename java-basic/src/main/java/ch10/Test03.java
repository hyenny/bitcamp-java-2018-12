...
class Monitor1 {
  //인스턴스 변수가 생성되면 0으로 자동 초기화된다.
  // byte, short, int, long = 0
  // float, double = 0.0
  // boolean = false
  // char = '\u0000'
  //
  // 주의! 로컬 변수는 자동 초기화되지 않는다.
  //
  int bright; // 밝기 (0% ~ 100%)
...
public class Test03 {
  public static void main(String[] args) {
    ...
    // 그래야 모니터의 기능(funtion=method)을 제대로 사용할 수 있다.

    // 다음은 모니터 인스턴스를 만든 후에 모니터 인스턴스를 사용하는 사용자가
