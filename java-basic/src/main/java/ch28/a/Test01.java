...
// => 다른 주석과 달리 컴파일이나 컴파일 할 때나 실행할 때 추출할 수 있다.
// => 애노테이션 문법이 사용되기 전에 일반 주석에 특별한 문법을 포함시켜 사용했던 doclet이라는 기술이 있었다.
// => 일반 주석과 달리 프로퍼티=값 형태로 값을 다룰 수 있다.
// => 사용법
//      - 애노테이션 저으이 또는 기존에 정의된 애노테이션 사용
//      - 클래스나 인터페이스에 적용
// => 애노테이션이 .class 파일에 있는 것을 확인하라!
package ch28.a;

@MyAnnotation // 클래스 선언에 붙일 수 있다.
//@MyAnnotation // 중복으로는 붙일 수는 없다.
public class Test01 {
  ...
  void m1(@MyAnnotation int p1, // 파라미터(로컬변수)에 붙일 수 있다.
