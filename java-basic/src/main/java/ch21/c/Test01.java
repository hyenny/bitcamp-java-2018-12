...
public class Test01 {
  ...
  public static void main(String[] args) {
    ...
    //    이 예외도 Exception 계열의 메서드다.
    //    즉 반드시 try ~ catch를 사용하여 예외를 처리해야 한다.
    //
    // newInstance() 메서드
    // => 생성자를 이용하여 인스턴스를 만든다.
