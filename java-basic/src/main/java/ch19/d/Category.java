...
public class Category {
  ...
  final static class computer {
    public static final int mouse = 101;
    public static final int keyboard = 102;
    public static final int moniter = 103;
  ...
  finalstatic class appliance {
    ...
    public static final int APPLIANCE_VACUUM = 204;
    
  }
  
  final static class book {
    public static final int BOOK_POET = 301;
