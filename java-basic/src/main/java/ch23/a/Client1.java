...
public class Client1 {
  public static void main(String[] args) throws Exception {
    ...
    // => 서버와 연결이 이루어지면 Socket 객체를 리턴한다.
    Socket socket = new Socket(
        "127.0.0.1", // IP 주소(ex: 234.3.4.56) 또는 도메인명(ex: www.daum.net)
              // 특수IP : 127.0.0.1 - 로컬 컴퓨터를 가리킨다.
    ...
    //      => 물론 해제하지 않아도 서버측에서 일정 시간이 지나면 자동으로 연결된 자원을 해제한다.
