...
//      인터페이스 
public class MyCustomClassEditor extends PropertyEditorSupport {
  
  // 스프링 IoC 컨테이너는 String을 java.sql.Date 클래스로 바꿀 때
  // 그리고 getValue()를 호출하여 변환된 값을 꺼내 쓴다.
  @Override
  public void setAsText(String text) {
    System.out.printf("MyCustomClassEditor.setAsText(%s)\n", text);
