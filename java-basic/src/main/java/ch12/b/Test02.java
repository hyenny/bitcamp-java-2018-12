 ...
 *   - 인스턴스 멤버 : 인스턴스 필드, 인스턴스 블럭, 인스턴스 메서드, 생성자
 * 2). 상속(inheritance)
 *   - 기능 확장을 위한 문법
 * 3). 캡슐화(encapsulation)
 *   - 외부의 접근을 제어하는 문법
 ...
 *   - 오버로딩(overloading) 
 *      : 메서드 시그니처가 다르더라도 같은 기능을 하는 메서드에 대해 같은 이름을 갖게하여
 *        일관성 있는 프로그래밍을 하게 도와주는 문법
 *   - 오버라이딩(overriding)
 *      : 상속 받은 메서드를 자신의 역할에 맞게 재정의하는 것
 *   - 다형적 변수(polyomrhpic variable)
 ...
 *     - protected : 같은 패키지에 소속되거나 자식 클래스의 멤버만 접근 간으
 *     - public : 모두 접근 가능
 *     
 * # getter/setter
 * - 캡슐화와 더불어 사용되는 기술이다.
