...
public class Test02 {
    ...
    public static void main(String[] args) {
      ...
      System.out.println(5/2); //int와 int의 계산 결과는 int이다.
      ...
      System.out.println(f1+f2); // float와 float의 계산 결과는 float이다.
      ...
      // 그래서 보통 부동소스점을 다룰 때는 double을 많이 사용한다.
