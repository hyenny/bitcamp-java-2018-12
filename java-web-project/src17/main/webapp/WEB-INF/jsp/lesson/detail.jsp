          ...
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              <textarea class="form-control" id="contents"
                name="contents" rows="3" cols="50">${lesson.contents}</textarea>
            </div>
          </div>
          <div class="form-group row">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              <input type="number" class="form-control-plaintext"
                id="totalHours" value="${lesson.totalHours}">
            </div>
          </div>
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              <input type="number" class="form-control-plaintext"
                id="dayHours" value="${lesson.dayHours}">
            </div>
          </div>
          <div class="form-group row">
            <div class="col-sm-10">
              <a class="btn btn-primary" href='.'>목록</a> <a
                class="btn btn-primary" href='delete/${lesson.no}'>삭제</a>
