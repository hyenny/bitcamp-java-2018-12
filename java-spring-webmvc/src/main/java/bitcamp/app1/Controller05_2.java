...
public class Controller05_2 {
  ...
  public String handler2() {
    ...
    // http://localhost:8080/java-spring-webmvc/jsp/c05-2.jsp
    //
    // 이것을 막으려면, 다음과 같이 WEB-INF 폴더 밑에 JSP 파일을 두어라.
    // /WEB-INF 폴더에 있는 파일은 클라이언트에서 직접 요청할 수 없다.
  ...
  public View handler3() {
    return new JstlView("/WEB-INF/jsp/c05_2.jpg");
  }
  
  @GetMapping("h4")
  public ModelAndView handler4() {
    ModelAndView mv = new ModelAndView();
    mv.setViewName("/WEB-INF/jsp/c05-2.jsp");
    return mv;
  }
  
  @GetMapping("h5")
  public String handler5() {
    // 리다이렉트를 지정할 때는 URL 옆에 "redirect:" 접두어를 붙인다.
    // 즉 HTTP 응답이 다음과 같다.
