...
values(101, '자바 프로그래밍', '자바 프로그래밍 배우기', '2019-1-1', '2019-2-20', 200, 6);
insert into lms_lesson(lesson_id, titl, conts, sdt, edt, tot_hr, day_hr)
values(102, 'C/.C++ 프로그래밍', '프로그래밍 배우기', '2019-2-1', '2019-3-20', 200, 6);
insert into lms_lesson(lesson_id, titl, conts, sdt, edt, tot_hr, day_hr)
values(103, '파이썬 프로그래밍', '프로그래밍 배우기', '2019-3-1', '2019-4-20', 200, 7);
insert into lms_lesson(lesson_id, titl, conts, sdt, edt, tot_hr, day_hr)
values(104, '웹 프로그래밍', '프로그래밍 배우기', '2019-4-1', '2019-5-20', 300, 7);
insert into lms_lesson(lesson_id, titl, conts, sdt, edt, tot_hr, day_hr)
values(015, 'IoT프로그래밍', '프로그래밍 배우기', '2019-5-1', '2019-6-20', 400, 8);
...
-- 수업 사진 게시물 예제 데이터
insert into lms_photo(photo_id, lesson_id, titl) values (1, 101, '자바 컴파일러 구동 원리');
insert into lms_photo(photo_id, lesson_id, titl) values (2, 101, '자바 클래스 실행하는 방법');
insert into lms_photo(photo_id, lesson_id, titl) values (3, 101, '옵저버 패턴 클래스 다이어그램');
insert into lms_photo(photo_id, lesson_id, titl) values (4, 104, 'HTML/CSS/JavaScript 관계');
insert into lms_photo(photo_id, lesson_id, titl) values (5, 104, '자바 스크립트 구동 원리');
