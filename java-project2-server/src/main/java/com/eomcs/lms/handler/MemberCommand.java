...
public class MemberCommand {
  ...
  public void list(ServletRequest request, ServletResponse response) {
    ...
    out.println("<div><form action='/member/search' method='GET'>");
    ...
    for (Member member : members) {
      out.println(String.format("<tr> <td>%d</td> <td><a href='/member/detail?no=%1$d'>%s</td> <td>%s</td> <td>%s</td> <td>%s</td></tr>", 
  ...
  public void detail(ServletRequest request, ServletResponse response) throws Exception {
    ...
    out.println(String.format("<tr> <th>전화</th>"
        ...
        + "</tr>", member.getTel()));
    out.println(String.format("<tr> <th>가입일</th>"
        + "<td><input type='text' name='registerdDate'></td>"
  ...
  public void update(ServletRequest request, ServletResponse response) throws Exception {
    ...
    member.setPhoto(request.getParameter("photo"));
    member.setTel(request.getParameter("tel"));
    member.setRegisteredDate(Date.valueOf(request.getParameter("registerdDate")));
  ...
  public void form(ServletRequest request, ServletResponse response) throws Exception {
    ...
    out.println("  <td><textarea name='name' rows='1' cols='50'></textarea></td>");
    out.println("</tr>");
    out.println("<tr>");
    out.println("  <th>이메일</th>");
    out.println("  <td><textarea name='email' rows='1' cols='50'></textarea></td>");
    out.println("</tr>");
    out.println("<tr>");
    out.println("  <th>암호</th>");
    out.println("  <td><textarea name='password' rows='1' cols='50'></textarea></td>");
    out.println("</tr>");
    out.println("<tr>");
    out.println("  <th>사진</th>");
    out.println("  <td><textarea name='photo' rows='1' cols='50'></textarea></td>");
    out.println("</tr>");
    out.println("<tr>");
    out.println("  <th>전화</th>");
    out.println("  <td><textarea name='tel' rows='1' cols='50'></textarea></td>");
    out.println("</tr>");
    out.println("</table>");
    out.println("<p>");
