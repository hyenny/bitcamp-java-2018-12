...
values('자바 프로그래밍', '자바 프로그래밍 배우기', '2019-1-1', '2019-2-20', 200, 6);
insert into lms_lesson(titl, conts, sdt, edt, tot_hr, day_hr)
values('C/.C++ 프로그래밍', '프로그래밍 배우기', '2019-2-1', '2019-3-20', 200, 6);
insert into lms_lesson(titl, conts, sdt, edt, tot_hr, day_hr)
values('파이썬 프로그래밍', '프로그래밍 배우기', '2019-3-1', '2019-4-20', 200, 7);
insert into lms_lesson(titl, conts, sdt, edt, tot_hr, day_hr)
values('웹 프로그래밍', '프로그래밍 배우기', '2019-4-1', '2019-5-20', 300, 7);
insert into lms_lesson(titl, conts, sdt, edt, tot_hr, day_hr)
values('IoT프로그래밍', '프로그래밍 배우기', '2019-5-1', '2019-6-20', 400, 8);
